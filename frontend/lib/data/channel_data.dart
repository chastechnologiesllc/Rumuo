...
class ChannelData {
  ...
  /// the frontend mock catalog, loaded by ResourceCategoryData). This is what
  ...
  /// to 15× across the mock general catalog + 14 category files, producing 655 Channel
  ...
  /// → the mock general catalog channels. A channel that is both category-specific and
