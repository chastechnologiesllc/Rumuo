...
///
/// Data is loaded once at startup from `the in-code mock catalog`
...
/// the in-code mock catalog. Deliberately NOT the same
...
class ResourceCategory {
  ...
  /// the in-code mock catalog (kept in sync with the
